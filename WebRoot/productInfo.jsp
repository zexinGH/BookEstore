...
<script type="text/javascript">
	function addProductToCart(id) {
		location.href = "cart?method=add&id=" + id;
		alert("商品成功添加到购物车!");
	}
</script>
</head>
<body>
	...
	<div class="ahz-head">
		<div class="wrap clearfix">
			<h2 class="ahz-head-leftCon">${p.name}</h2>
			<div class="ahz-head-rightCon">
				<span><font color="#f84858">概述</font></span><b>|</b> <span>商品价格：<font
					color="#f84858">${p.price}</font>元
				</span> <b>|</b> <span>所属类别：<font color="#f84858">${p.category}</font></span>
				<b>|</b> <span>商品数量:<font color="#f84858">${p.pnum}</font></span> <a
					class="buy" href="javascript:void(null)"
					onclick="addProductToCart('${p.id}')">立即购买</a>
			</div>
		</div>
	</div>
	...
	<div class="xq">
		<div class="wrap clearfix">
			<div class="dimg">
				<img src="./${p.imgurl_s}" width="390" height="390">
			</div>
			<div class="dms">
				<p>商品描述</p>
